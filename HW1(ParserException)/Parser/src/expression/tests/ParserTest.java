...
public class ParserTest extends BaseTest {
    ...
    public final List<Op<LongUnaryOperator>> unary = new ArrayList<>();
    public final List<List<Op<LongBinaryOperator>>> levels = new ArrayList<>();
    public List<Op<TExpression>> tests;
